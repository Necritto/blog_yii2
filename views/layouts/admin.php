...
<body>
  ...
  <footer class="footer">
    <div class="container">
      <p class="pull-left">&copy; Blog Yii2 <?= date('Y') ?></p>

      <p class="pull-right">Made by <a href="https://github.com/necritto" target="_blank" rel="noopener noreferrer">Necritto</a></p>
    </div>
  </footer>
